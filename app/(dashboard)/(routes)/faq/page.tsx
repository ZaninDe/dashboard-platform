...
const Faq = () => {
  ...
  return (
    <div className="w-full md:h-[80vh] flex justify-center items-center text-5xl px-4 md:px-32 mb-[100px]">
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1">
          <AccordionTrigger className="text-base text-start md:text-center md:text-2xl">
